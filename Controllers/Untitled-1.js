...
const UserProfilePic = async (userIds,sex) => {
    ...
    try {
        ...
        let profile_img = user !== null ? `https://firebasestorage.googleapis.com/v0/b/voter-29270.appspot.com/o/${user.profile_img}?alt=media` :(sex==="1"? 'https://firebasestorage.googleapis.com/v0/b/voter-29270.appspot.com/o/boypic.jpg?alt=media&token=6d9dc8a7-8c16-48d6-8df2-8e37c6cef89b':'https://firebasestorage.googleapis.com/v0/b/voter-29270.appspot.com/o/girlpic.jpg?alt=media&token=9227e456-c6ea-414f-87a0-991bce8b81a2')
